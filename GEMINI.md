...
- `tester.go`: Xray process lifecycle and latency testing
- `proxy.go`: protocol parsing, URI generation, and Xray outbounds
...
- All Xray child processes must be canceled and reaped.
