...
func (s *Service) publishIntegrations(ctx context.Context, working []proxy.ProxyServer) {
...
func pushFiles(parent context.Context, c config.Config, updates map[string]string) error {
	if c.GitRepoURL == "" {
...
func runGit(ctx context.Context, c config.Config, dir string, args ...string) error {
...
func runGitNetwork(ctx context.Context, c config.Config, dir string, args ...string) error {
	var err error
...
func subscriptionText(servers []proxy.ProxyServer) string {
